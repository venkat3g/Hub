...
public class XmlParser1 {
    ...
    /**
     * XML Parsing class. Takes a file and returns the root node of the xml
     * file.
     * 
     * @param file
     ...
     *            file to check for root node.
     * @param bo
     *            boolean to notify if file exists or not.
     * @throws Exception
     *             exception if not able to find file.
     */
    ...
    public void saveFile() throws TransformerException {
        ...
        /*
         * Adds whitespace to the output file. Does not properly add whitespace
         * to first element.
         */
